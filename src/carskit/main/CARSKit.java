...
public class CARSKit {
    ...
    protected Recommender getRecommender(SparseMatrix[] data, int fold) throws Exception {
        ...
        switch (algOptions.getMainParam().toLowerCase()) {
            ...
            ////////////// [VSL] Contextual postfiltering algorithms /////////////////////////////////////////

            case "pof_adjusting": { // [VSL] postfiltering adjusting
    			String recsys_traditional = algOptions.getString("-traditional").trim().toLowerCase();
    			double beta = algOptions.getDouble("-beta", 0.5);
    			Recommender recsys = null;
    			switch (recsys_traditional) {
    			///////// baseline algorithms
    			///////// //////////////////////////////////////////////////////////
    			...
    			if (recsys == null)
    				...
    				recsys.setPostFilteringAdjusting(beta);
    				return recsys;
    			}
    		}
    		case "pof_dev": { // [VSL] postfiltering deviations
    			String recsys_traditional = algOptions.getString("-traditional").trim().toLowerCase();
    			int topK = algOptions.getInt("-topK", 20);
    			Recommender recsys = null;
    			switch (recsys_traditional) {
    			///////// baseline algorithms
    			///////// //////////////////////////////////////////////////////////
    			...
    			if (recsys == null)
    				...
    				recsys.setPostFilteringDev(topK);
    				return recsys;
    			}
    		}    		
